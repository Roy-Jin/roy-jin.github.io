<template>
    <Scrollable ref="scrollRef">
        <div class="wrapper">
            <div class="ForMe">
                <div class="base">
                    <svg id="avatar" class="cursor-target" style="cursor: none !important;" width="100%" height="100%" viewBox="0 0 200 200"
                        ...
                        <foreignObject x="0" y="0" width="200" height="200" clip-path="url(#circleClip)">
                            <div xmlns="http://www.w3.org/1999/xhtml"
                                ...
                                <video width="200" height="200" autoplay loop muted playsinline disablepictureinpicture
